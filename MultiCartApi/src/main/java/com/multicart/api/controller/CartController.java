...
public class CartController {
    ...
    public ResponseModel addToCart(@RequestBody CartRequestModel requestModel){
        ...
        if(status){
            return new ResponseModel("Product added to cart successfully", HttpStatus.OK.value());
        }
        return new ResponseModel("Error adding product to cart", HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
    ...
    public ResponseModel deleteFromCart(@RequestBody CartRequestModel requestModel){
        ...
        if(status){
            return new ResponseModel("Product removed from cart successfully", HttpStatus.OK.value());
        }
        return new ResponseModel("Error removing product from cart", HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
    ...
    public ResponseModel updateCart(@RequestBody CartRequestModel requestModel){
        ...
        if(status){
            return new ResponseModel("Product updated in cart successfully", HttpStatus.OK.value());
        }
        return new ResponseModel("Error updating cart product.", HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
    ...
    public ResponseModel emptyCart(@RequestBody CartRequestModel requestModel){
        ...
        if(status){
            return new ResponseModel("Cart is empty now.", HttpStatus.OK.value());
        }
        return new ResponseModel("Error making the cart empty.", HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
}
